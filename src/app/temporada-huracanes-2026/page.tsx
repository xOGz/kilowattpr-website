...
export const metadata: Metadata = {
  ...
  description:
    'La temporada de huracanes 2026 comienza el 1 de junio. Instala paneles solares con batería de respaldo para proteger tu familia. Sistemas desde $11,950. Kilowatt PR — 4.9★ en Google.',
  keywords:
      ...
      <section className="bg-navy-dark text-white py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 text-sm mt-4">
            Sistemas desde $11,950 con batería incluida
          </p>
        </div>
      </section>
