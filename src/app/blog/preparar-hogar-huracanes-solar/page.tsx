...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.kilowattpr.com/blog/preparar-hogar-huracanes-solar/' },
}
...
export default function HurricanePreparationPage() {
  ...
  const url = 'https://www.kilowattpr.com/blog/preparar-hogar-huracanes-solar/'
