...
module.exports = {
  ...
  additionalPaths: async (config) => {
    ...
    const englishPaths = [
      ...
      { loc: '/en/services/commercial-solar/', changefreq: 'monthly', priority: 0.7 },
      ...
      { loc: '/en/blog/how-net-metering-works-puerto-rico/', changefreq: 'monthly', priority: 0.7 },
      { loc: '/en/blog/solar-battery-vs-gas-generator/', changefreq: 'monthly', priority: 0.7 },
      { loc: '/en/blog/what-to-do-after-luma-outage/', changefreq: 'monthly', priority: 0.7 },
      { loc: '/en/blog/home-battery-backup-guide-puerto-rico/', changefreq: 'monthly', priority: 0.7 },
